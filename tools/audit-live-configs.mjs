...
export const CONFIGS = [
  ...
  { id: "2-hpe-art",       year: "2",  cur: "Australian Curriculum", subject: "Health and Physical Education", kind: "article", stim: "steps10k", move: "Reason with Evidence" },
  // ---------- Year 3 ----------
  { id: "3-science-vid",   year: "3",  cur: "Australian Curriculum", subject: "Science", kind: "video",   stim: "lava", move: "Build Explanations" },
  { id: "3-english-art",   year: "3",  cur: "Australian Curriculum", subject: "English", kind: "article", stim: "wildlifecarers", move: "Wondering" },
  // ---------- Year 4 ----------
  ...
  { id: "6-english-art",   year: "6",  cur: "Australian Curriculum", subject: "English", kind: "article", stim: "cartoons", move: "Make Connections" },
  // ---------- Year 7 ----------
  ...
  { id: "7-maths-art",     year: "7",  cur: "Australian Curriculum", subject: "Mathematics", kind: "article", stim: "steps10k", move: "Reason with Evidence",
    intention: "We are learning to test whether a round number like 10,000 is backed by real data" },
  // ---------- Year 8 ----------
  ...
  { id: "9-econ-art",      year: "9",  cur: "Australian Curriculum", subject: "Economics and Business (7–10)", kind: "article", stim: "childcare", move: "Reason with Evidence", focus: 2 },
  // ---------- Year 10 ----------
  { id: "10-english-art",  year: "10", cur: "Australian Curriculum", subject: "English", kind: "article", stim: "hanson", move: "Consider Different Viewpoints",
  ...
  { id: "11-legal-art",    year: "11", cur: "VCE", subject: "Legal Studies", kind: "article", stim: "cfmeu", move: "Reason with Evidence" },
  ...
  { id: "12-psych-art",    year: "12", cur: "VCE", subject: "Psychology", kind: "article", stim: "ariana", move: "Uncovering Complexity" },
  ...
  { id: "12-dp-art",       year: "12", cur: "IB DP", subject: "Environmental Systems and Societies", kind: "article", stim: "feralcats", move: "Uncovering Complexity" },
];

// Article stimulus keys -> a matcher against the fetched pack (titles vary run to run).
export const ARTICLE_MATCH = {
  steps10k:       /10,?000 steps/i,
  wildlifecarers: /wildlife carers/i,
  pocketmoney:    /pocket money|chores/i,
  cartoons:       /political cartoons/i,
  childcare:      /childcare/i,
  hanson:         /Pauline Hanson/i,
  cfmeu:          /CFMEU|royal commission/i,
  ariana:         /Ariana Grande/i,
  feralcats:      /feral cats/i,
};
